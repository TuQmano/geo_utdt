...
`r icons::fontawesome("globe")` [tuqmano.com](https://www.tuqmano.com/) 

`r icons::fontawesome("twitter")` [@tuqmano](https://twitter.com/TuQmano) 

`r icons::fontawesome("github")` [/tuqmano](https://github.com/tuqmano) 
...
`r icons::fontawesome("globe")` [Rpubs-pablotis](https://rpubs.com/pablotisco) 

`r icons::fontawesome("twitter")`[@pabblo_h](https://twitter.com/pabblo_h)

`r icons::fontawesome("github")`[/pablotis](https://github.com/pablotis) 
