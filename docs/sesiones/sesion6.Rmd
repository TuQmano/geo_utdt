...
* [Spatial Data Science](https://r-spatial.org/book/), Edzer Pebesma y Roger Bivand (2023)
...
knitr::include_graphics("https://r-spatial.org/book/images/sf_deps.png")

```

Fuente: [_Spatial Data Science_](https://r-spatial.org/book/)
...
Fuente: [_Spatial Data Science_](https://r-spatial.org/book/03-Geometries.html) (ver detalle)

---

### Operaciones - [Spatial Data Science](https://r-spatial.org/book/03-Geometries.html#sec-opgeom)
...
<https://r-spatial.org/book/03-Geometries.html#sec-opgeom>
...
```{r, echo=FALSE, out.width="80%"}
knitr::include_graphics("https://r-spatial.org/book/images/sf_obj.png")
```
...
background-image: url(../figs/geoAr.png)
