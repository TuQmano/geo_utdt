...
`r icons::icon_style(icons::fontawesome("globe"), fill = "#fdbd15")` [estacion-r](https://estacion-r.netlify.app/) 
...
* 2011: Nace el entorno de desarrollo integrado (IDE) } `R Studio` (hoy propiedad de _Posit_) 

--

* 2020: 4.0V (_Arbor Day_)

--

* 2023: 4.3V (_Already Tomorrow_)
...
- Gran comunidad de usuaries colaborando (RLadies, RenBaires, LatinR, et. al.)
