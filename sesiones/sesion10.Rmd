...
knitr::include_graphics("https://github.com/TuQmano/geo_utdt2022/blob/main/sesiones/figs/clarin.png?raw=true")
```
 
 **P.Tiscornia**: https://rpubs.com/pablotisco/inmuebles_estado
