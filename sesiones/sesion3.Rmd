...
knitr::include_graphics("https://es.r4ds.hadley.nz/diagrams/es/data-science.svg")
```
...
## `r icons::fontawesome("book")` Referencias
...
read.csv(file = "data/inmuebles-estado-nacional.csv",
         encoding = "UTF-8")
```
...
read_csv(file = "data/inmuebles-estado-nacional.csv")
```
...
#### `r icons::fontawesome("link")` [`{readr}`](https://github.com/rstudio/cheatsheets/raw/master/translations/spanish/data-import-Spanish_translation-2019.pdf) Cheatsheet
...
#### `r icons::fontawesome("link")`[`{haven}`](https://haven.tidyverse.org/)
...
[`r icons::fontawesome("link")` {googlesheets4}](https://googlesheets4.tidyverse.org/)
...
`r icons::fontawesome("link")` [{datapasta}](https://milesmcbain.github.io/datapasta/)
...
`r icons::fontawesome("link")` [docs.google.com/spreadsheet](https://docs.google.com/spreadsheets/d/1J84PviVxVMsCDzupOcD0_s_yc92vm4sCB6uoJQtl2mU/)
...
`r icons::fontawesome("link")` [R4DS en espaÑol](https://es.r4ds.hadley.nz/datos-ordenados.html)

`r icons::fontawesome("link")` Wickham, H; [_Tidy Data_, Journal of Statistical Software](http://www.jstatsoft.org/v59/i10/paper)
...
knitr::include_graphics("../figs/dato_ancho.png")
```
...
```{r echo=FALSE, out.width = '80%', fig.align = 'center'}
knitr::include_graphics("../figs/dato_largo.png")
```
...
`r icons::fontawesome("link")`[`{tidyr}`](https://tidyr.tidyverse.org/)
...
#### Uno a uno, principales verbos de `{dplyr}` para manipular la _data_ 
