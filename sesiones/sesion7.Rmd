...
## `r icons::fontawesome("book")` Referencias (I)
...
## `r icons::fontawesome("book")` Referencias (II)
...
#### _Dibujando por capas_ con [`r icons::fontawesome("link")``{ggplot2}`](https://ggplot2.tidyverse.org/index.html)


```{r, echo = FALSE, out.width= '35%'}
knitr::include_graphics("https://github.com/TuQmano/geo_utdt2022/blob/main/fig/ggplot_layers.png?raw=true")
```

--

**`r icons::fontawesome("youtube")`** [_Plotting Anything with `ggplot2`_](https://www.youtube.com/watch?v=h29g21z0a68) - Thomas Lin Pedersen.
...
### `millas` del   [paquete `r icons::fontawesome("link")``{datos}`](https://cienciadedatos.github.io/datos/)
...
knitr::include_graphics("https://d33wubrfki0l68.cloudfront.net/2f8f27c472d7df78486e248c40931019b286361b/10d08/visualize_files/figure-html/unnamed-chunk-7-1.png")
```
...
**`r icons::fontawesome("link")`** Más detalle en esta [Intro a ggplot]("https://es.r4ds.hadley.nz/visualización-de-datos.html")
...
[`sesiones/scripts/primer_ggplot.R`](https://github.com/TuQmano/geo_utdt/blob/master/sesiones/scripts/primer_ggplot.R)